...
/*
IMPORTANT:
To create a tree with classes they need a default constructor (one without input values):
Default Constructor
MyClass::MyClass()
{
}
...
Create Tree:
tree<McClass> treeMyClass;
*/
/*
Code to create a testTree
o o o o o		leafs only have values no identifier
\|/  \/
o   o			second (value 3)
\/
o			first (value 2)
|
o			root (has the value 1)
void initiateTestTree() {
tree<int> testTree;
tree<int>::iterator root = testTree.insert(testTree.begin(), 1);
tree<int>::iterator first = testTree.append_child(root, 2);
tree<int>::iterator second = testTree.append_child(first, 3);
tree<int>::iterator third = testTree.append_child(first, 4);
testTree.append_child(second, 5);
testTree.append_child(second, 6);
testTree.append_child(second, 7);
testTree.append_child(third, 8);
testTree.append_child(third, 9);

kptree::print_tree_bracketed(testTree, std::cout);
}
...
//	*/
//	tree<int> testTree;
//	tree<int>::iterator root = testTree.insert(testTree.begin(), -100);
//	tree<int>::iterator first = testTree.append_child(root, 2);
//	tree<int>::iterator second = testTree.append_child(first, 3);
//	tree<int>::iterator third = testTree.append_child(first, 4);
//	testTree.append_child(second, 5);
...
//	*/
//	std::cout << "Root #children :" << root.number_of_children() << std::endl;
//	std::cout << "First #children :" << first.number_of_children() << std::endl;
//	std::cout << "Second #children :" << second.number_of_children() << std::endl;
//	std::cout << "Third #children :" << third.number_of_children() << std::endl;
//	std::cout << " " << std::endl;
//
//	/*
//	* Use breadth_first search with root
//	*/
//	std::cout << "Breadth First: " << std::endl;
//	tree<int>::breadth_first_iterator br = testTree.begin();
//	while (br != testTree.end(testTree.begin())) {
//		cout << (*br) << endl;
//		++br;
//	}
//
//	/*
//	* Use breadth_first search and give parent of each node (!Dont start with root, it has no parent [parent of root is NULL])
//	*/
//	std::cout << "Breadth First with parent: " << std::endl;
//	tree<int>::breadth_first_iterator bre = testTree.begin(root);
//	while (bre != testTree.end(root)) {
//		cout << " " << endl;
//		cout << (*testTree.parent(bre)) << endl;
//		cout << (*bre) << endl;
//		++bre;
//	}
//
...
//	* Only Print leafs
//	*/
//	std::cout << "Only leafs: " << std::endl;
//	tree<int>::leaf_iterator sib = testTree.begin_leaf();
//	while (sib != testTree.end_leaf()) {
//		cout << (*sib) << endl;
//		++sib;
//	}
//
...
//	*/
//	std::cout << "Only leafs: " << std::endl;
//	tree<int>::leaf_iterator sibParent = testTree.begin_leaf();
//	while (sibParent != testTree.end_leaf()) {
//		cout << (*sibParent) << endl;
//
//		tree<int>::iterator parent = testTree.parent(sibParent);
//		//tree<int>::iterator parent = sibParent;
//		while (parent != NULL) {
//			cout << "     " << *parent << endl;
//			parent = testTree.parent(parent);
//		}
//		++sibParent;
//	}
//
//	/*
//	* Use tree_util.hh to print tree
//	*/
//	std::cout << "Print tree stru: " << std::endl;
//	kptree::print_tree_bracketed(testTree, std::cout);
//}
